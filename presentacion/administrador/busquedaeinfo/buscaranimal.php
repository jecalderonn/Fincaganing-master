  ...
  <!-- Sidebar Menu -->
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="buscaranimal.php">Buscar Animal y Generar Resultados</a></li>  
          </ul>
      ...
      <!--------------------------
       ...
       <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Buscar por corral y genere informe de animales</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form action="../../../controlador/buscaranimales.php" target="_blank" method="post" role="form">
              <div class="box-body">
        <!-- select -->
                <div class="form-group">
                  <label>Corrales en Registro</label>
                  <select class="form-control" name="corral">
                    <?php $buscar->cargarCorrales(); ?>
                  </select>
                </div>
                </div>
                <div class="box-footer">
                <button type="submit" name="buscar" onclick="alert('Resultados generados correctamente')" class="btn btn-primary">Generar Informe de Busqueda</button>
                </div>    
            </form>
    </section>
    <!-- /.content -->

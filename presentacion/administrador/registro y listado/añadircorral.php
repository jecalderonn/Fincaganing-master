        ...
        -------------------------->
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Ingrese los datos para agregar un nuevo corral</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form action="../../../controlador/registrocorral.php" method="post" role="form">
              <div class="box-body">
                <div class="form-group">
                  <label>Codigo</label>
                   <input class="form-control" name="codigo" placeholder="Corral + numero" required>
                </div>
                
                <div class="form-group">
                  <label>Extension</label>
                   <input class="form-control" name="extension" placeholder="Ej: 1000m2" required>
                </div>
                
                <div class="form-group">
                  <label>Ubicacion</label>
                   <input class="form-control" name="ubicacion" placeholder="Ej: Lote1norte" required>
                </div>

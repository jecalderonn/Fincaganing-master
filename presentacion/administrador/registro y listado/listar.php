  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Listar Animal</li>
      </ol>
    </section>
<section>
    ...
    <section class="content container-fluid">
      ...
      <!--------------------------
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Animales en Inventario</h3>
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                <tr>
                  ...
                  <th>Codigo Corral</th>
                  <th>Ubicacion Corral</th>
                  <th>Raza</th>
                  <th>Precio</th>
                  <th>Estado</th>
                </tr>
                  <?php $info->cargarInventario(); ?>
              </table>
            </div>
            <!-- /.box-body -->
          </div>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Conteo</h3>

            <!-- /.box-header -->
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                 <?php $info->mostrarCantidadAnimales(); ?>
              </table>
            </div>
            <!-- /.box-body -->
          </div>

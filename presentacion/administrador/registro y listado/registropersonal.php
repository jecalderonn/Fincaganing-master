        ...
        -------------------------->
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Ingrese los datos para registrar a nuevo trabajador</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form action="../../../controlador/registronomina.php" method="post" role="form">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label>Cedula</label>
                   <input class="form-control" name="cedula" placeholder="Ingrese la cedula" required>
                </div>

                 <div class="form-group">
                  <label>Ocupacion o Cargo</label>
                  <select class="form-control" name="rol">
                    <?php $cargar->cargarRoles(); ?>
                  </select>
                </div>

                 <div class="form-group">
                  <label>Asignar Corral</label>
                ...
                <div class="form-group">
                  <label>Telefono</label>
                   <input class="form-control" name="telefono" placeholder="Ingrese el telefono" required>
                </div>
                </div>

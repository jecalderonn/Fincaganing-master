...
<head>
  ...
  <title>Registro Sacrificio</title>
...
<div class="navbar-custom-menu">
  ...
  <!-- Sidebar Menu -->
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="../nacimientosacrificio/registronacimiento.php">Registrar Nacimiento</a></li>
            <li><a href="../nacimientosacrificio/registrosacrificio.php">Listar Sacrificio</a></li>  
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Registrar 
        <small>Sacrificio</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i>Registro Nacimiento/Sacrificio</a></li>
        <li class="active">Registrar Sacrificio</li>
      </ol>
    </section>
<section>
